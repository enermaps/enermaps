...
const baseLayer = new L.tileLayer('https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png', {
...
for (let nuts_index = 0; nuts_index < 4; nuts_index++) {
...
const drawingLayer = new L.DrawingLayer();
