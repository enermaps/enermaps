...
let base_layers = new L.layerGroup();
...
' <a href="https://cartodb.com/attributions">CartoDB</a>'
	...
	base_layers.addLayer(base_layer)
	base_layers.addTo(map);
...
<LayerSelection bind:active_selection_layer={active_selection_layer} bind:active_overlay_layers={active_overlay_layers}/>
<div id="map"></div>
